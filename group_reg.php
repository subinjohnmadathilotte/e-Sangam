...
//echo $password;
                  ...
                  $files= "files/".time()."".htmlspecialchars($_FILES['files']['name']);
                  move_uploaded_file($_FILES['files']['tmp_name'], $files);
			
/* status=1 for active user and  status=0 for deleted user
     type=1 group */ 
 
//			$sqll="INSERT INTO `login_tb` ( `pass`,`username`,`status`,`type`) VALUES ('$password','$reg_no',1,1)";
...
//				echo"<script>alert('successful')</script>";
  ...
  $sql="INSERT INTO `group_tb`(  `reg_no`, `g_name`, `email`, `district`, `panchayath`, `ward`, `no_members`, `files1`, `phone`,`login_id`) VALUES ('$reg_no','$group_name','$email','$district','$panchayath','$ward','$no_members','$files','$phone','$login_id')";
...
<!--                    <li><a href="group_reg.php"><h2>Group registration<h2></a></li>-->
  ...
  <br>
    ...
    <div class="row">
		...
		<tr>
			...
			<input  type="number"  name="reg_no" class=" form-control"  required ></td>
		</tr>
		
		<tr>
		    <td class="td_pad">Group Name  </td><td class="td2_pad">
			<input  type="text"  name="group_name" class=" form-control" required ></td>
		</tr>
			
        <tr>
		    <td class="td_pad">District  </td>
			<td class="td2_pad">
			<select class=" form-control" id="district_select" name="district" >
		    ...
		    <td class="td_pad">No of members  </td><td class="td2_pad">
                        <input  type="number"  name="no_members" class=" form-control" required ></td>
			</tr>
			
			 <tr>
	        <td class="td_pad">Upload File</td>
	 	    <td class="td2_pad"><input type="file" name="files" id="files" class=" form-control" required></td>
	      </tr>
			...
			<input  type="tel"  name="phone" class=" form-control"  ></td>
			</tr>
 ...
 <footer>
       <p><h3> Department of Government of Kerala, Thiruvananthapuram, Kerala, India - 695011, 
         Phone: 91-471-2554714, Fax: 91-471-2554714, Email: info@kudumbashree.org</h3></p> /p>
    </footer>
